...
# 可选：只搜索我创建的文档（v1.0.54+）
lark-cli drive +search --query "<关键词>" --doc-types docx --created-by-me --format json
# 或搜索特定为的文档（v1.0.54+）
lark-cli drive +search --query "<关键词>" --doc-types docx --original-creator-ids "<open_id1>,<open_id2>" --format json
